...
const actualizarPuntuacion = (jugador1, jugador2) => {
    ...
    const destino = document.querySelector(".mesa-juego");
    puntos.innerText=`${jugador1.puntosPartido} - ${jugador2.puntosPartido}`;
    ...
    jugador1.cartas.forEach(carta => {
        ...
        boton.addEventListener("click", () => {
            ...
            if(palo.innerText !== "" && numero.innerText !== "") {
                ...
                alerta.innerText = jugador1.nick + " ya jugó, compare cartas.";
                const destinoAlerta = document.querySelector(".mesa-juego .cartas .jugadores .jugador1 .alerta");
                destinoAlerta.appendChild(alerta);*/
            } else {
